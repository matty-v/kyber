...
func TestParseCodexLatest(t *testing.T) {
	...
	data := `{"type":"event_msg","payload":{"type":"token_count","info":{"last_token_usage":{"input_tokens":100,"cached_input_tokens":60,"cache_write_input_tokens":4},"model_context_window":258400}}}` + "\n"
	...
	if s == nil || s.Tokens.Used != 100 || s.Tokens.Input != 40 || s.Tokens.CacheRead != 60 || s.Tokens.Limit != 258400 {
