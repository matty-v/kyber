...
| Profiles | routes_agents handleAgentAvatar; control-plane TaskObjectStore wiring | Document private PNG/JPEG/WebP up to 1 MiB; uploads currently require durable tasks enabled plus object storage |
