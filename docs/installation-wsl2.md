...
**Verify:**
```bash
helm show chart oci://ghcr.io/matty-v/charts/kyber --version 1.4.1 \
  | grep -E '^(name|version):'
...
Use the newest version from https://github.com/matty-v/kyber/releases in place of `1.4.1` — the chart version and the release tag are the same number.
