...
export const legacyRuntimeContracts: RuntimeDescriptor[] = [
  { id: 'claude-code', legacyCatalogKey: 'models', legacyVersionsKey: 'claudeCodeVersions', name: 'Claude Code', contractVersion: '1.0', profile: 'interactive-tmux-v1', cancellation: 'notify_only', features: ['model-catalog'], authModes: [
  ...
  { id: 'codex', legacyCatalogKey: 'codexModels', legacyVersionsKey: 'codexVersions', name: 'Codex (ChatGPT)', contractVersion: '1.0', profile: 'interactive-tmux-v1', cancellation: 'notify_only', features: ['model-catalog'], authModes: [
...
export function supportsModelSelection(contract: RuntimeDescriptor | undefined) {
  return contract?.features.includes('model-catalog') ?? false
}
